...
* Rename the main package to be the same as `mod_base_package` in the properties file, e.g. `com.laugic.bysmuth`
...
* Add mixins under the `mixin` package inside your main package, e.g. `com.laugic.bysmuth.mixin`
